...
if (window.location.href.indexOf("orders") <= -1){
        ...
        let side_cart = document.getElementById('side_cart_btn');
        if (side_cart){
            document.getElementById('side_cart_btn').href='/orders/cart';
        }
    }


    //Sliders .... Moved to swiper activator
    //Sliders .... Moved to swiper activator
    //Sliders .... Moved to swiper activator
    //Sliders .... Moved to swiper activator
    //Sliders .... Moved to swiper activator
    ...
    //                 "<input type='hidden' name='resend' id='resend' value='True'><a href='" + js_phone_number + "' class='link-border-verify form-account-link'>ارسال مجدد</a>"
    //             );
    //         }
    //     });
    // }
